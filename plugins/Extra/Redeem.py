...
async def add_redeem_code(client, message):
    ...
    if len(message.command) == 3:
        ...
        response_text = f"""
<b>Fʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ ɢɪғᴛ ᴄᴏᴅᴇ ɢᴇɴᴇʀᴀᴛᴇᴅ ✅
Aᴍᴏᴜɴᴛ:</b> {num_codes}
...
<b>𝙹𝚞𝚜𝚝 𝚌𝚕𝚒𝚌𝚔 𝚝𝚑𝚎 𝚊𝚋𝚘𝚟𝚎 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚌𝚘𝚙𝚢 𝚊𝚗𝚍 𝚝𝚑𝚎𝚗 𝚜𝚎𝚗𝚍 𝚝𝚑𝚊𝚝 𝚌𝚘𝚍𝚎 𝚝𝚘 𝚝𝚑𝚎 𝙱𝚘𝚝, 𝚝𝚑𝚊𝚝'𝚜 𝚒𝚝 🔥</b>"""
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("♻️ Redeem Here ♻️", url="https://telegram.me/Alphaa_Movie_Bot")],
                [InlineKeyboardButton("❕ Any Query ❕", url="https://t.me/TMR_DEVELOPER")]
            ]
        )
